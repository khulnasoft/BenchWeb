...
class BenchmarkConfig:
    def __init__(self, args):
        ...
        self.db_root = os.path.join(self.fw_root, "infrastructure", "docker", "databases")
        self.lang_root = os.path.join(self.fw_root, "frameworks")
        self.results_root = os.path.join(self.fw_root, "results")
        self.wrk_root = os.path.join(self.fw_root, "benchmarks", "load-testing", "wrk")
        self.scaffold_root = os.path.join(self.fw_root, "benchmarks", "pre-benchmarks")
