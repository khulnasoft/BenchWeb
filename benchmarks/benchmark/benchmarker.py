...
from benchmarks.utils.output_helper import log, FNULL
from benchmarks.utils.docker_helper import DockerHelper
from benchmarks.utils.time_logger import TimeLogger
from benchmarks.utils.metadata import Metadata
from benchmarks.utils.results import Results
from benchmarks.utils.audit import Audit
...
class Benchmarker:
    ...
    def __exit_test(self, success, prefix, file, message=None):
        ...
        if self.config.mode == "benchmark":
            ...
            # let's clean up leftover test images (khulnasoft/bw.test.test-name)
