        ...
        def verify_type(test_type):
            ...
            with open(os.path.join(verificationPath, 'verification.txt'),
                ...
                try:
                    ...
                    results = [('fail', """Caused Exception in BW
            ...
            including this message: %s\n%s""" % (e, traceback.format_exc()),
                ...
                def output_result(result, reason, url):
                    specific_rules_url = "https://github.com/KhulnaSoft/BenchWeb/wiki/Project-Information-Framework-Tests-Overview#specific-test-requirements"
                    color = Fore.GREEN
