...
class Metadata:
    ...
    def parse_config(self, config, directory):
        ...
        """
        from benchmarks.benchmark.framework_test import FrameworkTest
        tests = []
    ...
    def validate_test(test_name, test_keys, project_name, directory):
        ...
        windows_url = "https://github.com/KhulnaSoft/BenchWeb/issues/1038"
        schema = {
            'language': {
            ...
            'os': {
                ...
                [('Linux',
                 ...
                 ('Windows',
                  'BW is not fully-compatible on windows, contribute towards our work on compatibility: %s'
                  % windows_url)]
            },
            'database_os': {
                'required_with':
