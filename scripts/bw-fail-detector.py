...
USAGE: python bw-fail-detector.py
"""
...
def find_failing_frameworks(driver, run_uuids):
  ...
  for run_uuid in run_uuids:
    driver.get("https://bw-status.khulnasoft.com/results/%s" % run_uuid)
    assert "BW Status" in driver.title
...
if __name__ == '__main__':
  driver = get_driver()
  driver.get("https://bw-status.khulnasoft.com/")
  assert "BW Status" in driver.title
