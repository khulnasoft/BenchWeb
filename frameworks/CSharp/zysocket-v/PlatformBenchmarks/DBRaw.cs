...
namespace PlatformBenchmarks
{
    public class RawDb
    {
        ...
        public RawDb(ConcurrentRandom random, DbProviderFactory dbProviderFactory)
        {
            ...
            _connectionString = "Server=bw-database;Database=hello_world;User Id=benchmarkdbuser;Password=benchmarkdbpass;Maximum Pool Size=256;NoResetOnClose=true;Enlist=false;Max Auto Prepare=3";
