...
namespace Benchmarks.Model
{
    ...
    public sealed class DatabaseContext : DbContext
    {
        ...
        private static DbContextOptions<DatabaseContext> GetOptions(bool tracking)
        {
            ...
            optionsBuilder.UseNpgsql("Server=bw-database;Database=hello_world;User Id=benchmarkdbuser;Password=benchmarkdbpass;Maximum Pool Size=256;NoResetOnClose=true;Enlist=false;Max Auto Prepare=4");
