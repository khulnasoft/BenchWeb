...
std::string json_encode(const std::vector<khulnasoft_outjson_t> &json_reflectobj)
     ...
     unsigned int json_decode(khulnasoft_outjson_t &json_reflectobj,const std::string &_json_data,unsigned int _offset)
     {           
             bool _isarray=false;
...
unsigned int json_decode(std::vector<khulnasoft_outjson_t> &json_reflectobj,const std::string &_json_data,unsigned int _offset)
      {          
             bool _isarray=false;
        for(;_offset<_json_data.size();_offset++)
        {
