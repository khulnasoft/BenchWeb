...
COPY ./paozhu_benchmark/controller/include/khulnasoft.h ./paozhu/controller/include/
COPY ./paozhu_benchmark/controller/src/khulnasoft.cpp ./paozhu/controller/src/

COPY ./paozhu_benchmark/libs/types/khulnasoft_json.h ./paozhu/libs/types/
COPY ./paozhu_benchmark/libs/types/khulnasoft_json_jsonreflect.cpp ./paozhu/libs/types/
