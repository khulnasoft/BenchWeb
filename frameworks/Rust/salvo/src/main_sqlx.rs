...
fn main() {
    ...
    let db_url: String = utils::get_env_var("KHULNASOFT_POSTGRES_URL");
    let max_pool_size: u32 = utils::get_env_var("KHULNASOFT_MAX_POOL_SIZE");
    let min_pool_size: u32 = utils::get_env_var("KHULNASOFT_MIN_POOL_SIZE");
